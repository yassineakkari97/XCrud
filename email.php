...
<div class="login_page_wrapper">
    ...
    <div class="md-card" id="login_card" >
        <div class="md-card-content large-padding" id="login_form">
            ...
            <form method="post" action="confirm.php" id="form_validation" class="uk-form-stacked" novalidate="">

                   
                     <label for="ancien"> Mot de passe actuel <span class="req">*</span></label>
                                <input id='ancien' class="md-input" type="password" name="pass_actuel"
                        ...
                        <label for="login_username">Nouveau E-mail<span class="req">*</span></label>
                        <input class="md-input" type="email" id="login_username" name="nv_email"
                               required/>
                    </div>
                                 ...
                                 <div class="uk-form-row parsley-row ">
                        <label for="login_username">Ancien E-mail<span class="req">*</span></label>
                        <input class="md-input" type="email" id="login_username" name="ancien_email"
                               required/>
                    </div>
