...
function scrollbarWidth() {
    var e = jQuery('<div style="width: 100%; height:200px;">test</div>'), i = jQuery('<div style="width:200px;height:150px; position: absolute; top: 0; left: 0; visibility: hidden; overflow:hidden;"></div>').append(e), a = e[0], e = i[0];
...
$(function () {
    "use strict";
    altair_page_onload.init(), altair_main_header.init(), altair_main_sidebar.init(), altair_secondary_sidebar.init(), altair_top_bar.init(), altair_page_heading.init(), altair_md.init(), altair_forms.init(), altair_helpers.truncate_text($(".truncate-text")), altair_helpers.full_screen()
...
}), easing_swiftOut = [.4, 0, .2, 1], bez_easing_swiftOut = $.bez(easing_swiftOut);
...
altair_page_onload = {
    ...
    hide_content_sidebar: function () {
        $body.hasClass("header_double_height") || ($page_content.css("max-height", $html.height() - 40), $html.css({
            paddingRight: scrollbarWidth(),
            overflow: "hidden"
        }))
    }, show_content_sidebar: function () {
        $body.hasClass("header_double_height") || ($page_content.css("max-height", ""), $html.css({
            paddingRight: "",
            overflow: ""
        }))
    }
    ...
    init: function () {
        altair_forms.textarea_autosize(), altair_forms.select_elements(), altair_forms.switches()
    }, textarea_autosize: function () {
        $textarea = $("textarea.textarea_autosize,textarea.md-input"), $textarea.each(function () {
            $(this).hasClass("autosize_init") || (autosize($("textarea.textarea_autosize,textarea.md-input")), $(this).addClass("autosize_init"))
        })
        ...
        e.length && e.each(function () {
            if (!$(this).siblings(".switchery").length) {
                var e = this, i = $(e).attr("data-switchery-size"), a = $(e).attr("data-switchery-color"), t = $(e).attr("data-switchery-secondary-color");
                new Switchery(e, {
        ...
        window.ParsleyConfig = window.ParsleyConfig || {}, window.ParsleyConfig.validators = window.ParsleyConfig.validators || {}, window.ParsleyConfig.validators.date = {
            fn: function (e) {
                ...
                if (null == i)return !1;
                var a = e.split(/[.\/-]+/), t = parseInt(a[1], 10), n = parseInt(a[0], 10), s = parseInt(a[2], 10);
    ...
    init: function () {
        $sidebar_main.length && ($body.hasClass("sidebar_mini") || null !== localStorage.getItem("altair_sidebar_mini") ? (altair_main_sidebar.mini_sidebar(), setTimeout(function () {
            $window.resize()
        ...
        }), altair_helpers.custom_scrollbar($sidebar_main), $body.hasClass("sidebar_main_active") && $window.width() < 1220 ? altair_page_content.hide_content_sidebar() : altair_page_content.show_content_sidebar(), altair_main_sidebar.main_menu(), altair_main_sidebar.swipe_open()), altair_main_sidebar.lang_switcher())
        ...
        $sidebar_main.find(".menu_section > ul").children("li").each(function () {
            ...
            i.next("ul").velocity(a, {
                duration: 400, easing: easing_swiftOut, begin: function () {
                    "slideUp" == a ? $(this).closest(".submenu_trigger").removeClass("act_section") : $(this).closest(".submenu_trigger").addClass("act_section")
                }, complete: function () {
                    if ("slideUp" !== a) {
        ...
        $body.addClass("sidebar_mini").removeClass("sidebar_main_active sidebar_main_open sidebar_main_swipe"), $sidebar_main_toggle.hide(), $sidebar_main.find(".menu_section > ul").children("li").each(function () {
            var e = $(this).children("ul").length;
            e ? ($(this).addClass("sidebar_submenu"), $(this).find(".act_item").length && $(this).addClass("current_section")) : UIkit.tooltip($(this), {})
        })
    }
    ...
    init: function () {
        altair_main_header.search_activate(), $("#menu_top_dropdown").children().on("show.uk.dropdown", function (e) {
            setTimeout(function () {
                $window.resize()
            }, 320)
        })
    ...
    init: function () {
        altair_md.inputs(), altair_md.checkbox_radio(), altair_md.card_fullscreen(), altair_md.card_expand(), altair_md.card_overlay(), altair_md.card_single(), altair_md.card_panel(), altair_md.list_outside(), altair_md.fab_speed_dial(), altair_md.fab_toolbar(), altair_md.fab_sheet()
    }, card_fullscreen: function () {
        $(".md-card-fullscreen-activate").on("click", function () {
            var e = $(this).closest(".md-card"), i = e.height(), a = e.width();
            e.after('<div class="md-card-placeholder" style="width:' + a + "px;height:" + i + 'px;"/>'), e.addClass("md-card-fullscreen").css({
                width: a,
                height: i
            }).velocity({left: 0, top: 0}, {
                duration: 600, easing: easing_swiftOut, begin: function (i) {
                    e.find(".md-card-toolbar").prepend('<span class="md-icon md-card-fullscreen-deactivate material-icons uk-float-left">&#xE5C4;</span>'), altair_page_content.hide_content_sidebar()
                }
            }).velocity({height: "100%", width: "100%"}, {
                duration: 600, easing: easing_swiftOut, complete: function (i) {
                    $(window).resize(), e.find(".md-card-fullscreen-content").velocity("transition.slideUpBigIn", {
                        duration: 600,
                        easing: easing_swiftOut,
                        complete: function (e) {
                            $(window).resize()
            ...
            var e = $(".md-card-placeholder"), i = e.height(), a = e.width(), t = e.offset().top, n = e.offset().left, s = $(".md-card-fullscreen");
            s.velocity({height: i, width: a}, {
                duration: 600, easing: easing_swiftOut, begin: function (e) {
                    s.find(".md-card-fullscreen-content").velocity("transition.slideDownOut", {
                        duration: 275,
                        easing: easing_swiftOut
                    })
                }, complete: function (e) {
                    $window.resize(), s.find(".md-card-fullscreen-deactivate").remove(), altair_page_content.show_content_sidebar()
                }
            }).velocity({left: n, top: t}, {
                duration: 600, easing: easing_swiftOut, complete: function (i) {
        ...
        i && $body.hasClass("header_double_height") && (e(), $window.on("debouncedresize", function () {
            e()
        }))
    }, card_panel: function () {
        $(".md-card-close").on("click", function (e) {
            e.preventDefault();
            var i = $(this), a = i.closest(".md-card"), t = function () {
                $(a).remove()
            };
            ...
            $(a).toggleClass("md-card-collapsed").children(".md-card-content").slideToggle("280", bez_easing_swiftOut), i.velocity({
                ...
                duration: 280, easing: easing_swiftOut, complete: function () {
                    $(a).hasClass("md-card-collapsed") ? i.html("&#xE313;") : i.html("&#xE316;"), i.velocity("reverse")
                }
            })
        })
        ...
        $(".md-fab-speed-dial").children(".md-fab").append('<i class="material-icons md-fab-action-close" style="display:none">&#xE5CD;</i>').on("click", function () {
            var e = $(this), i = e.closest(".md-fab-wrapper");
            i.hasClass("md-fab-active") ? i.removeClass("md-fab-active") : i.addClass("md-fab-active"), e.velocity({scale: 0}, {
                duration: 140,
                easing: easing_swiftOut,
                complete: function () {
                    e.children().toggle(), e.velocity({scale: 1}, {duration: 140, easing: easing_swiftOut})
                }
            })
    ...
    truncate_text: function (e) {
        ...
        $hierarchical_show = $(".hierarchical_show"), $hierarchical_show.length && $hierarchical_show.each(function () {
            var e = $(this), i = e.children().length, a = 60;
            e.children().each(function (e) {
                $(this).css({"-webkit-animation-delay": e * a + "ms", "animation-delay": e * a + "ms"})
            }).end().waypoint({
                handler: function () {
                    ...
                    }, i * a + 1200), this.destroy()
                }, context: "window", offset: "90%"
            })
        })
    }, hierarchical_slide: function () {
        $hierarchical_slide = $(".hierarchical_slide"), $hierarchical_slide.length && $hierarchical_slide.each(function () {
            var e = $(this), i = e.attr("data-slide-children") ? e.children(e.attr("data-slide-children")) : e.children(), a = i.length, t = e.attr("data-slide-context") ? e.closest(e.attr("data-slide-context"))[0] : "window", n = 100;
            a >= 1 && (i.each(function (e) {
                $(this).css({"-webkit-animation-delay": e * n + "ms", "animation-delay": e * n + "ms"})
            }), e.waypoint({
                handler: function () {
        ...
        if (e) {
            for (var a = randID_generator(), t = i ? i : ["#e53935", "#d81b60", "#8e24aa", "#5e35b1", "#3949ab", "#1e88e5", "#039be5", "#0097a7", "#00897b", "#43a047", "#689f38", "#ef6c00", "#f4511e", "#6d4c41", "#757575", "#546e7a"], n = t.length, s = $('<div class="cp_altair" id="' + a + '"/>'), r = 0; n > r; r++)s.append("<span data-color=" + t[r] + ' style="background:' + t[r] + '"></span>');
            return s.append('<input type="hidden">'), $body.on("click", "#" + a + " span", function () {
