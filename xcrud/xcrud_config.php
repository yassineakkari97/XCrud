...
{
    // default connection
    public static $dbname = 'sofetes'; // Your database name
    ...
    // theme and language
    public static $theme = 'custom'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    public static $language = 'fr'; // sets default localization
    ...
    // map
    public static $default_point = '36.45376252757844,10.741367936134338';
    public static $default_text = 'Leaders University';
    public static $default_zoom = 18;
    public static $default_width = 700;
